  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-[#b4ff39] selection:text-black">
      ...
      <section className="pt-32 pb-24 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-display font-bold text-gray-900 leading-tight mb-6 capitalize">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <motion.a
              ...
              className="bg-[#b4ff39] text-black px-8 py-4 rounded-full font-bold text-lg shadow-xl shadow-[#b4ff39]/20 hover:scale-110 transition-transform"
            >
            ...
            <motion.a
              ...
              className="bg-black text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl hover:scale-110 transition-transform"
            >
              Call Now
            </motion.a>
            <motion.a
              ...
              className="flex items-center gap-2 text-black border-2 border-black/10 px-8 py-4 rounded-full font-bold text-lg hover:border-black transition-colors bg-white hover:scale-105"
            >
              <Play size={16} />
              See How We Work
            </motion.a>
